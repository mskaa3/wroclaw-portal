...
import UnivercityResults1 from './UnivercityResults1';
...
const Univercity1 = () => {
  ...
  const [selected_disc, setSelectedDisc] = useState({
    discipline_id: '',
    discipline_name: '',
  });
  const [select_disciplines, setSelectDisc] = useState([]);
  ...
  const handleDiscChange = (event) => {
    console.log(event);
    setSelectedDisc({
      discipline_id: event.value,
      discipline_name: event.label,
    });
  };
    ...
    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 align-left ">
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Select
          ...
          className="mt-2"
        >
          {!values.level && <option value="">Select level of study</option>}
        ...
        >
          {!values.city && (
            <option value="">Select city of study in Poland</option>
          )}
        ...
        <Select
          onChange={handleDiscChange.bind(this)}
          //onLoad={fetchFor}
          options={select_disciplines}
          value={selected_disc.discipline_name}
